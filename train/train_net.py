...
def convert_pretrained(name, args):
    ...
    #for mobilenet, del unused params
    del args['fc7_weight']
    del args['fc7_bias']
    return args
...
def train_net(net, train_path, num_classes, batch_size,
    ...
    scale = 1.0
    if net == 'mobilenet' or net == 'mobilenet_little':
        scale = 0.017
    ...
    #mod.bind(data_shapes=[('data', (1,3, 300, 300))], label_shapes=[('label', (1,69,5))])
    #mod.init_params(arg_params=args, aux_params=auxs, allow_missing=True)
    mod.fit(train_iter,
            val_iter,
