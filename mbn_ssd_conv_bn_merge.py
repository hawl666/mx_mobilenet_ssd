...
def merge_conv_bn(old_checkpoint, old_epoch, new_checkpoint):
    ...
    data_shape = 300
    sym_deploy = get_symbol('mobilenet_deploy', data_shape, num_classes=1, nms_thresh=0.5,force_nms=True, nms_topk=400)
    ...
    model_deploy.bind(data_shapes=[('data', (1, 3, data_shape, data_shape))], for_training=False)
